...
class ModulusCheckerSpec extends AnyWordSpecLike with Matchers with ScalaCheckDrivenPropertyChecks {
  ...
  "The SA reference checker" should {
    ...
    val InvalidReferences =
      Seq("", "123456", "1234567890K", "inv@lid123K", "inv@lid123K", "1nv@l-d~&*!", "1234567890E", "12345678905", "1097172564KZ")
  ...
  "The ePAYE reference checker" should {
    ...
    val ValidReferences = Seq("123PW12345678",
                              "450PE00923437",
                              "120PY19064375",
                              "450PA0096437K",
                              "853PW0076584X",
  ...
  "The Other taxes reference checker" should {
    ...
    val Valid14DigitReferences =
      Seq("XA012345678901", "XDS98712398712", "XDS98712398712", "XAP74589243785", "XE123456789012", "XM123995577846", "XM003425669813")
    ...
    val Invalid14DigitReferences =
      Seq("XF093624679222", "XW135792468123", "XFG03589343785", "inv@lid12A3456", "12345678901234", "X1234567890123", "XA1234567890AA")
    val Invalid15DigitReferences =
      Seq("X12345678901233", "XJ9876543210123", "XAP74589243785Z", "XP1234567890120", "XM7846942270421", "X23456789012345")
  ...
  def checkAllValid(checker: ReferenceChecker, refs: Seq[String]): Assertion = {
  ...
  def checkAllInvalid(checker: ReferenceChecker, refs: Seq[String]): Assertion = {
